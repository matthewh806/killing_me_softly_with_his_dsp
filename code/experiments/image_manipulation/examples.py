...
sox_mosh.databend_to_gif(os.path.join(CURRENT_DIRECTORY, "output_images/perfect_blue_manual.gif"),
                            [
                                [
                                    {"echos": {"gain_in": 0.2, "gain_out": 0.88, "delays": [2], "decays": [0.5]}},
                                    {"phaser": {"gain_in": 0.8, "delay": 1}}
                                ],
                                [
                                    {"echos": {"gain_in": 0.2, "gain_out": 0.88, "delays": [4], "decays": [0.5]}}
                                ],
                                [
                                    {"echos": {"gain_in": 0.2, "gain_out": 0.88, "delays": [6], "decays": [0.5]}},
                                    {"phaser": {"gain_in": 0.8, "delay": 3}}
                                ],
                                [
                                    {"echos": {"gain_in": 0.2, "gain_out": 0.88, "delays": [8], "decays": [0.5]}}
                                ],
                                [
                                    {"echos": {"gain_in": 0.2, "gain_out": 0.88, "delays": [8], "decays": [0.5]}},
