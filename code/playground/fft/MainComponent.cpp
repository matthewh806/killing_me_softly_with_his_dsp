...
MainComponent::MainComponent()
{
    ...
    {
        playButtonClicked(mReaderSource.get());
    };
    ...
    mPerformFFTButton.onClick = [this]
    {
        performFFT();
    };
    ...
    mPlayReconstructedSoundButton.onClick = [this]
    {
        playButtonClicked(mReconstructedReaderSource.get());
    };
...
void MainComponent::openButtonClicked()
{
    ...
    mFileChooser = std::make_unique<juce::FileChooser>("Select a Wave file to play...",
