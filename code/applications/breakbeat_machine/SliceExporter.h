...
namespace OUS
{
    ...
    public:
        ...
        void startExport(juce::AudioSampleBuffer* readBuffer, juce::String& fileName, juce::String& absoluteDirectoryPath, std::vector<SliceManager::Slice> const& slices, int numChannels, double sampleRate, int bitDepth, const int blockSize = 64);
        void stopExport();
